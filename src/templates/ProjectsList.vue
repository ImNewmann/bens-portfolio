<template>
  <section class="projects-list" ref="projectList">
    <ProjectBackground
      ...
      :backgroundURL="backgroundImages.image1"
    />
    <ProjectBackground
      ref="backgroundImage2"
      :backgroundURL="backgroundImages.image2"
    />
    ...
    <div
      ...
      v-on="
        !touchDevice
          ? {
              mouseover: () => {
                handleHover(this.animElems, true);
              },
              mouseleave: () => {
                handleHover(this.animElems, false);
              },
            }
          : {}
      "
  ...
  methods: {
    ...
    scroll() {
      ...
      document.addEventListener('touchstart', (e) => {
        this.touchStartVal = e.changedTouches[0].clientY;
      });
    ...
    handleBackgrounds(scrollDirection) {
      let backgroundActive = this.backgroundImages.image1Active
        ? 'image2'
        : 'image1';
    ...
    handleHover(components, onHover) {
      ...
      hoverTL
        ...
        .to(
          backgroundImage,
          0.4,
          { filter: `grayscale(${hoverOver ? 0.8 : 0})` },
          0
        );
    },
      ...
      if (action === 'out') {
        ...
        animateTL
          ...
          .to(
            components.currentTitleBase,
            0.4,
            { autoAlpha: 0, scale: 1, ease: 'power3.out' },
            0.4
          )
          .to(
          ...
          .to(
            ...
            1.8,
            { scale: 1, autoAlpha: 1, ease: 'power3.out' },
            0.4
          ) //BLUR OUT
          .to(
            components.counter,
    ...
    animateBackground(components) {
      ...
      const startingPointBG = this.backgroundImages.image1Active
        ? backgroundImage2
        : backgroundImage1;
      const endingPointBG = this.backgroundImages.image1Active
        ? backgroundImage1
        : backgroundImage2;
    ...
    animateProjectImage(components) {
      ...
      featuredImageTL
        .set(components.projectList, { pointerEvents: 'none' })
        .to(
          components.currentProjectImage,
          0.5,
          {
