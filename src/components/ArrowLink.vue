<template>
    <div
        ...
        ref="arrowLinkContainer"
        v-on="
            !touchDevice
                ? {
                      mouseover: () => {
                          handleHover(this.$refs, true);
                      },
                      mouseleave: () => {
                          handleHover(this.$refs, false);
                      },
                  }
                : {}
        "
...
export default {
    ...
    methods: {
        ...
        animOut() {
            ...
            tl.to(arrowLinkContainer, 0.4, { xPercent: -10, ease: 'power3.out' }, 0).to(
                arrowLinkContainer,
                0.7,
                { autoAlpha: 0, xPercent: 50, ease: 'power3.out' },
                0.2
            );
        },
        ...
        animIn() {
            ...
            gsap.fromTo(
                ...
                { autoAlpha: 1, xPercent: 0, ease: 'power3.out' }
            );
        },
    },
};
